...
and instances $x$ are vectors in $\mathcal{R}^n$ such that
...
Furthermore, let the instance have a positive label and contain assignments
$\left\{ a_{1}=1,a_{2}=0\right\} $.
